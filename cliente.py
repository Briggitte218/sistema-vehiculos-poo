...
if __name__ == "__main__":
    objCliente1 = Cliente(id=1, nombre='Briggitte Solis', email='brillysolis@mail.com',
                          genero='F', ocupacion='Comerciante', edad=25,
                          cedula='0934564432', sueldo=1500,
                          fecha_registro='2025-11-16', tipo_cliente='Premium')
